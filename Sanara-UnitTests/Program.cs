...
namespace Sanara_UnitTests
{
    public class Program : IClassFixture<Tests>
    {
        ...
        public async Task TestGameAnime()
            => await CheckGame(new SanaraV2.Games.Impl.Anime(null, new Config(0, Difficulty.Normal, "anime", false, false, APreload.Shadow.None, APreload.Multiplayer.SoloOnly), 0));

        [Fact]
        public async Task TestGameAzurLane()
            => await CheckGame(new SanaraV2.Games.Impl.AzurLane(null, new Config(0, Difficulty.Normal, "azurlane", false, false, APreload.Shadow.None, APreload.Multiplayer.SoloOnly), 0));

        [Fact]
        public async Task TestGameBooru()
            => await CheckGame(new SanaraV2.Games.Impl.Booru(null, new Config(0, Difficulty.Normal, "booru", false, false, APreload.Shadow.None, APreload.Multiplayer.SoloOnly), 0));

        [Fact]
        public async Task TestGameFateGO()
            => await CheckGame(new SanaraV2.Games.Impl.FateGO(null, new Config(0, Difficulty.Normal, "fatego", false, false, APreload.Shadow.None, APreload.Multiplayer.SoloOnly), 0));

        [Fact]
        public async Task TestGameKanColle()
            => await CheckGame(new SanaraV2.Games.Impl.KanColle(null, new Config(0, Difficulty.Normal, "kancolle", false, false, APreload.Shadow.None, APreload.Multiplayer.SoloOnly), 0));

        [Fact]
        public async Task TestGamePokemon()
            => await CheckGame(new SanaraV2.Games.Impl.Pokemon(null, new Config(0, Difficulty.Normal, "pokemon", false, false, APreload.Shadow.None, APreload.Multiplayer.SoloOnly), 0));

        [Fact]
        public async Task TestGameGirlsFrontline()
            => await CheckGame(new SanaraV2.Games.Impl.GirlsFrontline(null, new Config(0, Difficulty.Normal, "girlsfrontline", false, false, APreload.Shadow.None, APreload.Multiplayer.SoloOnly), 0));
