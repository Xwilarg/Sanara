...
{
    public static async Task<AnimeResult?> SearchMediaAsync(HttpClient client, JapaneseMedia media, string query, bool onlyExactMatch = false)
    {
    ...
    public static async Task<AiringSchedule[]> GetAnimeFeedAsync(HttpClient client)
    {
        var json = JsonConvert.SerializeObject(new GraphQL
        {
