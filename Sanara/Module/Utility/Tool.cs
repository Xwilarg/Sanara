...
{
    public static async Task<Embed> GetSourceAsync(HttpClient client, string paramUrl)
    {
        var html = await client.GetStringAsync("https://saucenao.com/search.php?db=999&url=" + Uri.EscapeDataString(paramUrl));
