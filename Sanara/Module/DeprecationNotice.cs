...
namespace Sanara.Module
{
    public class DeprecationNotice : ModuleBase
    {
        [Command("Botinfo"), Alias("Help", "Ping", "Gdpr",
            ...
            "Complete", "VNQuote", "Inspire", "Translate",
            "AdultVideo", "Doujinshi", "Cosplay", "Play")]
        public async Task Deprecated(params string[] _)
        {
            await ReplyAsync(
                ...
                $"Therefore {StaticObjects.BotName} is now adapting to these changes and all commands are moved to slash commands\n\n" +
                "**How does that works?**\n" +
