...
namespace SanaraV2.Community
{
    public class CommunityManager
    {
        ...
        public Profile GenerateProfile(Discord.IUser user, Image pfpImage = null)
        {
        ...
        public async Task CreateMyProfile()
        {
            ...
            using (HttpClient hc = new HttpClient()) // We can't get the bot profile picture from CurrentUser so we need to hardcode it
                GenerateProfile(Program.p.client.CurrentUser, Image.FromStream(await hc.GetStreamAsync("https://cdn.discordapp.com/avatars/329664361016721408/620b71193a2769a44f06eee302ddf0bf.png?size=128")));
        }
    }
}
